...
function formarPercentage(value) {
        ...
        <div className="col s6 m3 l2">
            <div style={styles.flexRow}>
                ...
                <div>
                    ...
                    <div className={classValue}><strong>{formatSignal(difference)}</strong></div>
                    <div className={classPercent}><strong>{formarPercentage(percentage)}</strong></div>
                </div>
            </div>
        </div>
    )
